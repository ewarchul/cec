...
double cec2017_hf04_modern(size_t dim, int fn, double *input, cec_state_t *state);
double cec2017_hf05_modern(size_t dim, int fn, double *input, cec_state_t *state);
double cec2017_hf06_modern(size_t dim, int fn, double *input, cec_state_t *state);
double cec2017_hf07_modern(size_t dim, int fn, double *input, cec_state_t *state);
double cec2017_hf08_modern(size_t dim, int fn, double *input, cec_state_t *state);
double cec2017_hf09_modern(size_t dim, int fn, double *input, cec_state_t *state);
double cec2017_hf10_modern(size_t dim, int fn, double *input, cec_state_t *state);
